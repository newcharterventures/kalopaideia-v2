...
const CULTURE_PROMPTS = {
  ...
  welsh: "Welsh literary and bardic culture: the early medieval Aneirin / Taliesin tradition; the Pedair Cainc and the courtly Gogynfeirdd; the cywydd masters Dafydd ap Gwilym and Tudur Aled; cynghanedd as a living craft (the strict-meter prosodic system of consonantal patterning and internal rhyme); the Eisteddfod tradition from the medieval bardic chairs through the 19th-c. revival; the Methodist Revival and Pantycelyn's hymnody; Saunders Lewis's Plaid Cymru founding and the modern Welsh literary renaissance; manuscript culture (the White Book of Rhydderch, the Red Book of Hergest); medieval Welsh law (Cyfraith Hywel)",
  oldnorse: "Old Norse culture in the saga age (c. 870\u20131262): the settlement of Iceland and the Greenland and Vinland colonies; the Althing at \u00deingvellir as the world's oldest extant parliament; the conversion of Iceland by lawful decision in 1000 CE; skaldic court poetry (the dr\u00e1pa as praise-form, the kenning as imagery); rune-stones and the Older / Younger Futhark scripts; the manuscript culture of medieval Iceland (Codex Regius, Flateyjarb\u00f3k, Hauksb\u00f3k); Norse mythology (\u00d3\u00f0inn, \u00de\u00f3rr, Freyja); the family-saga genre and its hard realism; viking trade-routes from the British Isles to Byzantium and the Caliphate; not the modern romantic-nationalist appropriation of Norse imagery",
};
